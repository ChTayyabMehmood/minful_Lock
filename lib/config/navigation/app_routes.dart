...
import 'package:mindful/ui/screens/turkey_mode/turkey_mode_screen.dart';
...
class AppRoutes {
  ...
  static const String turkeyModePath = '/turkeyMode';
  ...
  static final Map<String, Widget Function(BuildContext)> routes = {
    ...
    /// Turkey mode screen
    turkeyModePath: (context) => const TurkeyModeScreen(),
  };
}
