...
class TabDashboard extends ConsumerWidget {
  ...
  static List<Widget> _restrictions(BuildContext context) => [
        ...
        /// Turkey mode (digital detox)
        DefaultListTile(
          position: ItemPosition.bottom,
          leadingIcon: FluentIcons.phone_20_regular,
          titleText: "Turkey Mode",
          subtitleText: "Complete digital detox - block all non-essential apps",
          trailing: const Icon(FluentIcons.chevron_right_20_regular),
          onPressed: () =>
              Navigator.of(context).pushNamed(AppRoutes.turkeyModePath),
        ),
      ];
