...
object AppConstants {
    ...
    const val TURKEY_MODE_SERVICE_NOTIFICATION_ID: Int = 107

    // Turkey mode intent actions
    const val ACTION_UNLOCK_TURKEY_MODE: String = "com.mindful.android.action.UNLOCK_TURKEY_MODE"
    const val ACTION_START_TURKEY_MODE: String = "com.mindful.android.action.START_TURKEY_MODE"
    const val ACTION_STOP_TURKEY_MODE: String = "com.mindful.android.action.STOP_TURKEY_MODE"
    const val ACTION_TURKEY_MODE_STOPPED: String = "com.mindful.android.action.TURKEY_MODE_STOPPED"

    // SharedPreferences key for passphrase hash
    const val PREFS_UNLOCK_PASSPHRASE_HASH: String = "unlockPassphraseHash"
